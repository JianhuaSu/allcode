...
class BMSZ(nn.Module):
    def __init__(self, args):
        ...
        self.text_feat_dim, self.video_feat_dim, self.audio_feat_dim = 768, 1024, 768
        self.hidden_dims = args.hidden_dims
        self.output_dim = 20
        
        if args.sampler == 'beta':
            self.sampler = BetaSampler(args)
        elif args.sampler == 'dir':
            self.sampler = DirSampler(args)
        ...
        # transformer encoder
        self.text_bert = BERT.from_pretrained(args.text_backbone_path)
