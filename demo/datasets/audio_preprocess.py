...
class AudioFeature:
    ...
    def __init__(self, args, get_raw_audio = False):
        ...
        self.processor = AutoProcessor.from_pretrained(args.audio_model_path)
        self.model = WavLMModel.from_pretrained(args.audio_model_path)
            
        self.sr = args.audio_sr
    ...
    def __get_raw_audio(self, args):
        ...
        for file in tqdm(os.listdir(args.raw_video_path), desc = 'Files'):
            ...
            if os.path.isfile(file_path) and file.endswith('.mp4'):
                ...
                audio.write_audiofile(os.path.join(audio_data_path, "audio.wav"))
    ...
    def __save_audio_feats(self, args, audio_feats):
        ...
        audio_feats_path = os.path.join(args.audio_data_path, args.audio_feats)
