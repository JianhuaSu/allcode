...
class Metrics(object):
    ...
    def __call__(self, y_true, y_pred, show_results = False):
        ...
        eval_results = {
            ...
            'prec':  round(macro_prec * 100, 2),
            'weighted_prec':  round(weighted_prec * 100, 2),
            'rec':  round(macro_rec * 100, 2),
            'weighted_rec':  round(weighted_rec * 100, 2)
        }
...
class OID_Metrics(object):
    ...
    def __init__(self, args):
        ...
        self.logger = logging.getLogger(args.logger_name)
        self.eval_metrics = ['acc-all', 'f1-known',  'f1-open', 'f1-all']
