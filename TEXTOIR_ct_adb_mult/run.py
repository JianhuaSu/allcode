...
def parse_arguments():
    ...
    parser.add_argument("--data_path", default = '/home/sharing/disk2/sjh/intentDataset', type=str,
    ...
    parser.add_argument("--output_path", default= '/root/autodl-tmp/output', type=str, 
...
def set_up(args):
    ...
    args.pretrained_save_model = os.path.join(args.output_path, f"binary_{args.method}_{args.dataset}_{args.text_backbone}_{args.seed}")
...
def work(args, data, logger, debug_args=None):
    ...
    if args.method.startswith(('msz','text')):
